...
function start() {
  document
    .getElementById("codeCheck")
    .addEventListener("click", codeCheckClick, false);
}
...
function codeCheckClick() {
  ...
  document.getElementById("checkGTINID").innerHTML =
    "GTIN ID: " + checkGTINID(barcode);
  document.getElementById("formatBarcode").value = formatBarcode(barcode);
  document.getElementById("verify").innerHTML =
    "GS1 verified: " + verify(barcode);
  document.getElementById("getEANNumber").innerHTML =
    "EAN number: " + getEANnumber(barcode);
  document.getElementById("getLOTnumber").innerHTML =
    "LOT number: " + getLOTnumber(barcode);
  document.getElementById("getExpirationDate").innerHTML =
    "Expiration date: " + getExpirationDate(barcode);
  document.getElementById("getCatalogNumber").innerHTML =
    "Catalog number: " + getCatalogNumber(barcode);
  var res = parseGS1(barcode);
  document.getElementById("parseGS1").innerHTML =
    "Parsed GS1: " + res[0] + "*" + res[1] + "*" + res[2] + "*" + res[3];
  document.getElementById("GS1_1").innerHTML =
    "GS1_1: " +
    createGS1(
  ...
  document.getElementById("GS1_2").innerHTML =
    "GS1_2: " +
    createGS1(
      document.getElementById("eancode").value,
      document.getElementById("lotcode").value,
  ...
  document.getElementById("GS1_3").innerHTML =
    "GS1_3 ZPL: " +
    createGS1(
      document.getElementById("eancode").value,
      document.getElementById("lotcode").value,
  ...
  document.getElementById("GS1_4").innerHTML =
    "GS1_4 karakterek Code128 fonthoz: " +
    convertToXML(
      createGS1(
        document.getElementById("eancode").value,
        document.getElementById("lotcode").value,
  ...
  document.getElementById("GS1_4_barcode").innerHTML = convertToXML(
    createGS1(
      document.getElementById("eancode").value,
      document.getElementById("lotcode").value,
      document.getElementById("expirationcode").value,
...
function createGS1(
  ...
  if (outputStyle == "ZPL") {
    ...
    ret =
      ret +
      catalogNumberID +
      catalogNumber.slice(0, 8) +
      ">6" +
      catalogNumber.slice(8) +
      "^FS";
  }
  if (outputStyle == "Character") {
    ret =
      "ÍÊ!" +
      GS1charDictC[eanNumber.slice(0, 2)] +
      GS1charDictC[eanNumber.slice(2, 4)] +
      GS1charDictC[eanNumber.slice(4, 6)];
    ret =
      ret +
      GS1charDictC[eanNumber.slice(6, 8)] +
      GS1charDictC[eanNumber.slice(8, 10)] +
      GS1charDictC[eanNumber.slice(10, 12)];
    ret = ret + GS1charDictC[eanNumber.slice(12, 14)];
    ret =
      ret +
      "*" +
      GS1charDictC[lotNumber.slice(0, 2)] +
      GS1charDictC[lotNumber.slice(2, 4)];
    if (lotNumber.length > 4) {
    ...
    ret =
      ret +
      "Ê1" +
      GS1charDictC[expirationDate.slice(0, 2)] +
      GS1charDictC[expirationDate.slice(2, 4)] +
      GS1charDictC[expirationDate.slice(4)];
    ret =
      ret +
      "5" +
      GS1charDictC[catalogNumber.slice(0, 2)] +
      GS1charDictC[catalogNumber.slice(2, 4)];
    ret =
      ret +
      GS1charDictC[catalogNumber.slice(4, 6)] +
      GS1charDictC[catalogNumber.slice(6, 8)];
